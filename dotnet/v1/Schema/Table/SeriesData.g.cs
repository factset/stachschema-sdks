...
namespace FactSet.Protobuf.Stach.Table {
    ...
    static SeriesDataReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::FactSet.Protobuf.Stach.Table.SeriesData), global::FactSet.Protobuf.Stach.Table.SeriesData.Parser, new[]{ "Ranges", "DoubleArray", "FloatArray", "Int32Array", "Int64Array", "BoolArray", "StringArray", "DurationArray", "TimestampArray" }, new[]{ "Data" }, null, null, new pbr::GeneratedClrTypeInfo[] { null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ranges_.WriteTo(ref output, _map_ranges_codec);
      if (dataCase_ == DataOneofCase.DoubleArray) {
        output.WriteRawTag(162, 6);
        output.WriteMessage(DoubleArray);
      }
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          default:
            ...
            break;
          case 10: {
            ranges_.AddEntriesFrom(ref input, _map_ranges_codec);
            break;
          }
          case 802: {
            global::FactSet.Protobuf.Stach.Table.DoubleArray subBuilder = new global::FactSet.Protobuf.Stach.Table.DoubleArray();
