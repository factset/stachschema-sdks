...
namespace FactSet.Protobuf.Stach.Table {
    ...
    static MetadataLocationsReflection() {
      ...
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::FactSet.Protobuf.Stach.Table.MetadataLocations), global::FactSet.Protobuf.Stach.Table.MetadataLocations.Parser, new[]{ "Table", "Columns", "Rows" }, null, null, null, new pbr::GeneratedClrTypeInfo[] { null, null, })
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    void pb::IBufferMessage.InternalWriteTo(ref pb::WriteContext output) {
      ...
      columns_.WriteTo(ref output, _map_columns_codec);
    ...
    void pb::IBufferMessage.InternalMergeFrom(ref pb::ParseContext input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 18: {
            columns_.AddEntriesFrom(ref input, _map_columns_codec);
            break;
          }
          case 26: {
